...
const contrasenia2 = document.getElementById("id_repeated_password");
...
function validacionForm() {
  ...
  if (nombre.value.length < 1 || nombre.value.trim() == "") {
    mostrarMensajeError("myname", "Nombres nos validos*");
    condicion = false;
  }
  ...
  if (
    ...
    mostrarMensajeError("mobile", "Teléffono no valido*");
    condicion = false;
  }
  ...
  if (!terminosYcondiciones.checked) {
    mostrarMensajeError("termsAndConditions", "Aceptar los términos y condiciones*");
    condicion = false;
  } else {
